 ...
 */
// Preview build of oven-sh/WebKit#302 (current pin c6cfe90c + that change);
// bump to the merged commit once it lands.
export const WEBKIT_VERSION = "autobuild-preview-pr-302-05e4c162";
