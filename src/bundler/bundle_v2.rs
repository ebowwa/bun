...
pub use bv2_impl::{
    ...
    EventLoop, ImportTracker, PartRange, StableRef, WrapKind, generate_unique_key,
...
pub struct BundleV2<'a> {
    ...
    pub(crate) framework: Option<options::Framework>,
    ...
    pub(crate) server_component_manifests: Option<ServerComponentsManifests>,
    pub graph: Graph<'a>,
